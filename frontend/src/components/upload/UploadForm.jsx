...
export default function UploadForm() {
  ...
  return (
    <>
        ...
        {upload2Submitted && !upload3Submitted? <UploadForm3  setUpload3Content={setUpload3Content} setUpload3Submitted={setUpload3Submitted}  files={upload2Content} title={upload1Content.title} type={upload1Content.type}/> : ""}
